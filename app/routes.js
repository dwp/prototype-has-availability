...
/////
//v11
router.post('/manage-what11', function (req, res) {
  ...
  if (manage == "agents"){
    // Send user to what language page
    res.redirect('/v11/availability-management/agents/agent-profiles')
  } else {
    // Send user to next page
    res.redirect('/v11/availability-management/availability/availability-view')
  }
...
router.post('/status-check11', function (req, res) {
  ...
  if (status == "assessment-booked"){
    // Send user to what language page
    res.redirect('/v11/book-appt/update-status-assessment-booked')
  } else {
    // Send user to next page
    res.redirect('/v11/book-appt/update-status-confirmation')
  }
...
router.post('/select-hcp11', function (req, res) {
  ...
  if (selectagent == "choose-hcp"){
    // Send user to what language page
    res.redirect('/v11/book-appt/assign-hcp-while-booking')
  } else {
    // Send user to next page
    res.redirect('/v11/book-appt/more-info')
  }
...
router.post('/select-hcp11-manage', function (req, res) {
  ...
  if (selectagent == "choose-hcp"){
    // Send user to what language page
    res.redirect('/v11/has-manage-appt/assign-hcp-while-booking')
  } else {
    // Send user to next page
    res.redirect('/v11/has-manage-appt/appt-details-change-hcp')
  }
...
router.post('/cancel-cause', function (req, res) {
  ...
  if (apptreasoncancel == "Claimant"){
    // Send user to what language page
    res.redirect('/v11/book-appt/claimant-cancel-appointment')
  } else {
    // Send user to next page
    res.redirect('/v11/book-appt/provider-cancel-appointment')
  }
...
/////
//v12
router.post('/manage-what12', function (req, res) {
  ...
  if (manage == "agents"){
    // Send user to what language page
    res.redirect('/v12/availability-management/agents/agent-profiles')
  } else {
    // Send user to next page
    res.redirect('/v12/availability-management/availability/availability-view')
  }
...
router.post('/status-check12', function (req, res) {
  ...
  if (status == "assessment-booked"){
    // Send user to what language page
    res.redirect('/v12/book-appt/update-status-assessment-booked')
  } else {
    // Send user to next page
    res.redirect('/v12/book-appt/update-status-confirmation')
  }
...
router.post('/select-hcp12', function (req, res) {
  ...
  if (selectagent == "choose-hcp"){
    // Send user to what language page
    res.redirect('/v12/book-appt/assign-hcp-while-booking')
  } else {
    // Send user to next page
    res.redirect('/v12/book-appt/more-info')
  }
...
router.post('/select-hcp12-manage', function (req, res) {
  ...
  if (selectagent == "choose-hcp"){
    // Send user to what language page
    res.redirect('/v12/has-manage-appt/assign-hcp-while-booking')
  } else {
    // Send user to next page
    res.redirect('/v12/has-manage-appt/appt-details-change-hcp')
  }
...
router.post('/cancel-cause12', function (req, res) {
  ...
  if (apptreasoncancel == "Claimant"){
    // Send user to what language page
    res.redirect('/v12/book-appt/claimant-cancel-appointment')
  } else {
    // Send user to next page
    res.redirect('/v12/book-appt/provider-cancel-appointment')
  }
...
router.post('/cancel-cause12', function (req, res) {
  ...
  if (apptreasoncancel == "Claimant"){
    // Send user to what language page
    res.redirect('/v12/has-manage-appt/claimant-cancel-appointment')
  } else {
    // Send user to next page
    res.redirect('/v12/has-manage-appt/provider-cancel-appointment')
  }
...
router.post('/resched-cause12', function (req, res) {
  ...
  if (apptreasonresched == "Claimant"){
    // Send user to what language page
    res.redirect('/v12/book-appt/claimant-resched-appointment')
  } else {
    // Send user to next page
    res.redirect('/v12/book-appt/provider-resched-appointment')
  }
...
router.post('/resched-cause12b', function (req, res) {
  ...
  if (apptreasonresched == "Claimant"){
    // Send user to what language page
    res.redirect('/v12/has-manage-appt/claimant-resched-appointment')
  } else {
    // Send user to next page
    res.redirect('/v12/has-manage-appt/provider-resched-appointment')
  }
...
/////
//v13
router.post('/manage-what13', function (req, res) {
  ...
  if (manage == "agents"){
    // Send user to what language page
    res.redirect('/v13/availability-management/agents/agent-profiles')
  } else {
    // Send user to next page
    res.redirect('/v13/availability-management/availability/availability-view')
  }
...
router.post('/status-check13', function (req, res) {
  ...
  if (status == "assessment-booked"){
    // Send user to what language page
    res.redirect('/v13/book-appt/update-status-assessment-booked')
  } else {
    // Send user to next page
    res.redirect('/v13/book-appt/update-status-confirmation')
  }
...
router.post('/select-hcp13', function (req, res) {
  ...
  if (selectagent == "choose-hcp"){
    // Send user to what language page
    res.redirect('/v13/book-appt/assign-hcp-while-booking')
  } else {
    // Send user to next page
    res.redirect('/v13/book-appt/more-info')
  }
...
router.post('/select-hcp13-manage', function (req, res) {
  ...
  if (selectagent == "choose-hcp"){
    // Send user to what language page
    res.redirect('/v13/has-manage-appt/assign-hcp-while-booking')
  } else {
    // Send user to next page
    res.redirect('/v13/has-manage-appt/appt-details-change-hcp')
  }
...
router.post('/cancel-cause13', function (req, res) {
  ...
  if (apptreasoncancel == "Claimant"){
    // Send user to what language page
    res.redirect('/v13/book-appt/claimant-cancel-appointment')
  } else {
    // Send user to next page
    res.redirect('/v13/book-appt/provider-cancel-appointment')
  }
...
router.post('/cancel-cause13', function (req, res) {
  ...
  if (apptreasoncancel == "Claimant"){
    // Send user to what language page
    res.redirect('/v13/has-manage-appt/claimant-cancel-appointment')
  } else {
    // Send user to next page
    res.redirect('/v13/has-manage-appt/provider-cancel-appointment')
  }
...
router.post('/resched-cause13', function (req, res) {
  ...
  if (apptreasonresched == "Claimant"){
    // Send user to what language page
    res.redirect('/v13/book-appt/claimant-resched-appointment')
  } else {
    // Send user to next page
    res.redirect('/v13/book-appt/provider-resched-appointment')
  }
...
router.post('/resched-cause13b', function (req, res) {
  ...
  if (apptreasonresched == "Claimant"){
    // Send user to what language page
    res.redirect('/v13/has-manage-appt/claimant-resched-appointment')
  } else {
    // Send user to next page
    res.redirect('/v13/has-manage-appt/provider-resched-appointment')
  }
...
router.post('/appt-flexi-check13', function (req, res) {
  ...
  if (apptflexicheck == "Flexible appointment"){
    // Send user to what language page
    res.redirect('/v13/book-appt/appointmentflexi-duration')
  } else {
    // Send user to next page
    res.redirect('/v13/book-appt/app-date-time')
  }
